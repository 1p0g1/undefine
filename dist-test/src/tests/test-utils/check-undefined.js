 ...
 */
export function findUndefinedValues(obj, path = '') {
 ...
 */
export function assertNoUndefined(obj, message) {
    const undefinedPaths = findUndefinedValues(obj);
    if (undefinedPaths.length > 0) {
        throw new Error(`${message || 'Object contains undefined values'} at paths: ${undefinedPaths.join(', ')}`);
    }
}
//# sourceMappingURL=check-undefined.js.map