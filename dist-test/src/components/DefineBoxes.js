...
import { HINT_INDICES } from '../types/game.js';
import './DefineBoxes.css';
const DefineBoxes = ({ revealedHints, onHintReveal, isGameOver, hasWon, guessResults, }) => {
    ...
    return (_jsxs("div", { className: "define-boxes-container", children: [_jsx("span", { className: "un-prefix", children: "Un \u00B7" }), _jsx("div", { className: "define-boxes", children: defineLetters.map((letter, index) => {
                    ...
                    return (_jsx("div", { className: boxClass, onClick: () => !isGameOver && onHintReveal(letter), children: Object.keys(HINT_INDICES)[letter] }, letter));
                }) })] }));
};
export default DefineBoxes;
//# sourceMappingURL=DefineBoxes.js.map