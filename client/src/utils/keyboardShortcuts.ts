...
export const getKeyboardShortcutsEnabled = (): boolean => {
  return getFromStorage<boolean>(STORAGE_KEYS.KEYBOARD_SHORTCUTS_ENABLED, true);
};

/**
 * Sets the keyboard shortcuts enabled state
 */
export const setKeyboardShortcutsEnabled = (enabled: boolean): void => {
