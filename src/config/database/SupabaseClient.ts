...
export class SupabaseClient {
            ...
            return {
                ...
                equivalents: Array.isArray(dbWord.equivalents)
                    ...
                    : typeof dbWord.equivalents === 'string'
                        ? dbWord.equivalents.split(',').map((s) => s.trim())
                        : [],
    ...
    async getNextHint(session) {
        ...
        switch (nextHintType) {
            case 'D':
                hint = word.data.definition;
                break;
            case 'E2':
                hint = word.data.equivalents;
                break;
            case 'F':
                hint = word.data.first_letter;
                break;
            case 'I':
                hint = word.data.in_a_sentence;
                break;
            case 'N':
                hint = word.data.number_of_letters.toString();
                break;
            case 'E':
                hint = word.data.etymology;
                break;
