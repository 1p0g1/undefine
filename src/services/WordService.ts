...
import { GameWord, Word, WordClues } from '../../packages/shared-types/src/index.js';
...
export class WordService {
     ...
     */
    static async checkGuess(gameId: string, guess: string) {
        try {
     ...
     * Add a new word
     */
    static async addWord(wordData: Partial<WordData>): Promise<GameWord> {
        try {
     ...
     */
    static async updateWord(wordId: string, wordData: Partial<WordData>): Promise<GameWord> {
        try {
     ...
     */
    static mapToGameWord(word: Word): GameWord {
        const clues: WordClues = {
            D: word.definition,
            E: word.etymology || '',  // WordClues requires non-optional string
            F: word.first_letter,
            I: word.in_a_sentence || '',  // WordClues requires non-optional string
